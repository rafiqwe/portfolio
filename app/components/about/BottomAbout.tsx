      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12 md:gap-20">
        <div className="w-full md:w-1/2 space-y-8">
          ...
          <p className="text-sm  md:text-base text-gray-400 leading-relaxed font-corporatus">
            I work across the entire stack — building modern interfaces, writing
            scalable backend systems, and ensuring everything runs smoothly
            end-to-end. I bring a mix of creativity and professional discipline
            to every project, focusing on clean code, thoughtful design, and
